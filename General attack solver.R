#This code does the iteration of g given a cost to progress matrix

#Cost to progress matrix is of form [B+1,|V|] from C_{1,v} to C_{B+1,v} (a constant/possibly infinity)
